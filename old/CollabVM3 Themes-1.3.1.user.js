...
// seperate chat and header font
// clear input validity (:valid)
// custom font size
// custom padding
// backdrop-filter effects on objects
...
.borderLabel {\
    ...
    grid-column: 1;\
                             ...
                             .borderInput::-webkit-slider-runnable-track {\
                                background-color: var(--bs-body-bg) !important;\
                             }\
                             .borderInput::-moz-range-track {\
                                background-color: var(--bs-body-bg) !important;\
                             }\
                             .borderInput::-webkit-slider-thumb {\
                                background-color: var(--bs-primary-text-emphasis) !important;\
                              }\
                             .borderInput::-moz-range-thumb {\
                                background-color: var(--bs-primary-text-emphasis) !important;\
                              }\
                             .borderInput::-webkit-slider-thumb:active {\
                                background-color: var(--bs-primary) !important;\
                              }\
                             .borderInput::-moz-range-thumb:active {\
                                background-color: var(--bs-primary) !important;\
                              }\
                             .modal {\
                                --bs-modal-zindex: 200;\
